...
& = \frac{\partial^2}{\partial xy} f\\
\frac{\partial}{\partial y} (\frac{\partial}{\partial x} f)
& = \frac{\partial^2}{\partial yx} f\\
...
$$\frac{\partial^2}{\partial xy} f = \frac{\partial^2}{\partial yx} f$$.
...
$$\text{Hess}(f) = \begin{bmatrix}
  \frac{\partial^2}{\partial x^2} f & \frac{\partial^2}{\partial xy} f\\
  \frac{\partial^2}{\partial xy} f & \frac{\partial^2}{\partial y^2} f
\end{bmatrix}$$
"""
...
\begin{bmatrix}
  ...
  \frac{\partial^2 f}{\partial x_1x_3} & \cdots & \frac{\partial^2 f}{\partial x_1x_n}\\
  \frac{\partial^2 f}{\partial x_1x_2} & \frac{\partial^2 f}{\partial x_2^2} &
  \frac{\partial^2 f}{\partial x_2x_3} & \cdots & \frac{\partial^2 f}{\partial x_2x_n}\\
  \vdots & \ddots & \ddots & \ddots & \vdots\\
  \frac{\partial^2 f}{\partial x_1x_{n-1}} & \frac{\partial^2 f}{\partial x_2x_{n-1}} &
  \cdots & \frac{\partial^2 f}{\partial x_{n-1}^2} & \frac{\partial^2 f}{\partial x_{n-1}x_n}\\
  \frac{\partial^2 f}{\partial x_1x_n} & \frac{\partial^2 f}{\partial x_2x_n} &
  \cdots & \frac{\partial^2 f}{\partial x_{n-1}x_n} & \frac{\partial^2 f}{\partial x_n^2}\\
\end{bmatrix}$$
"""
...
function tangent_plane(f, x0, x1, y0, y1, cx, cy; Δ = 0.5, n = 32)
	...
	plot!([cx, cx+1], [cy, cy + 1], [fc, fc + grad[1] + grad[2]], linewidth = 10, color = Colors.JULIA_LOGO_COLORS.red, label = "")
	surface!(
...
# ╔═╡ 7f09ad43-3769-483c-b770-44cb3795888e
plotly()
...
manifest_format = "2.0"
project_hash = "0ec3217d1a8faa2e1e5b27ca6d8ca63acea8005c"
